# Ahmed Strategy Fusion Bot v1.11.1 — TRADER FIRST VALIDATED

## تنبيه مهم
هذا المشروع **بوت تنبيهات** ولا ينفذ أوامر شراء أو بيع في Binance. تحليل العملة والاستراتيجيات ومناطق الدخول والوقف والأهداف قواعد فنية قابلة للاختبار وليست ضمانًا للربح. يجب إجراء backtest وforward test على بيانات غير مستخدمة في ضبط القواعد قبل التداول الحقيقي.

## v1.11.1 — التحقق من المستويات وتسليم Telegram
- تحليل 4H و1H و15M يحدد BUY أو SELL أو WAIT قبل فحص الاستراتيجيات.
- لا تُقبل إشارة إذا كان وقف BUY فوق الدخول أو وقف SELL تحت الدخول.
- لا تُقبل مخاطرة أقل من 0.25 ATR أو أكبر من الحد الأقصى المسموح.
- تُبنى الأهداف من المخاطرة الفعلية عند 1R و2R و3R مع التحقق من ترتيبها.
- لا تسجل الإشارة في SQLite على أنها مرسلة إلا بعد نجاح استجابة Telegram، مع عدد محاولات محدود.
- تمت إضافة استراتيجية مستقلة باسم `Trend Compression Breakout`، ولا تدخل ضمن رسائل COMBO.
- تنبيهها الخاص يظهر بعبارة `انفجار محتمل`، لكنه لا يعني ضمان حدوث حركة قوية.
- شروطها الافتراضية: ضغط Bollinger/ATR، قرب الحد، حجم أعلى من المتوسط، وتدفق اتجاهي، ثم تأكيد حي.
